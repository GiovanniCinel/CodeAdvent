...
for circuit in circuits:
    circuits_dimension.append(len(circuit))
circuits_dimension.sort(reverse= True)

print("The solution is:", circuits_dimension[0] * circuits_dimension[1] * circuits_dimension[2])